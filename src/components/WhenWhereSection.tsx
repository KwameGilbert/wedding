    ...
    <div className={`py-12 px-4 ${className}`} style={{ backgroundColor: "#333333" }}>
      <motion.div variants={containerVariants} initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} className="flex flex-wrap -mx-4">
        ...
        <div className="flex flex-wrap lg:flex-nowrap gap-8 lg:gap-4 justify-center w-full px-4">
          <EventDetails title="Parking Location" date="2026-03-07T13:00:00" time="1:00 PM - 3:00 PM" address="Charlotte Street Car Park, Charlotte St, Bath BA1 2NE, United Kingdom" phone="+44 (793)650-8904" mapUrl="https://maps.app.goo.gl/Ua2QC5WvXWQzkqen8" icon={<img src={weddingCar} alt="Wedding Car" className="w-12 h-12 object-cover rounded-full" />} index={0} />
          <EventDetails title="The Reception" date="2026-03-07T15:30:00" time="3:30 PM - 9:00 PM" address="Percy Community Centre, New King St, Bath BA1 2BN, United Kingdom" phone="+44 (793)650-8904" mapUrl="https://maps.app.goo.gl/nDgwxcxTP9i5JkEi7" icon={<img src={champagne} alt="Champagne" className="w-12 h-12 object-cover rounded-full" />} index={1} />
        </div>
